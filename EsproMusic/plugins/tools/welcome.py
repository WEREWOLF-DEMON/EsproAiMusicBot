...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    #
    draw.text((630, 300), f'.  {user}', fill=(255, 255, 255), font=font)
    draw.text((630, 450), f'   {id}', fill=(255, 255, 255), font=font)
    draw.text((630, 230), f"   {uname}", fill=(255, 255, 255), font=font)
